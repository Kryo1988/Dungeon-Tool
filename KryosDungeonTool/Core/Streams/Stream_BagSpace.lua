-- luacheck: globals KryosDungeonTool GAMEMENU_OPTIONS FONT_SIZE UIParent NORMAL_FONT_COLOR C_Timer Enum C_Container GetContainerNumSlots GetContainerNumFreeSlots
