-- luacheck: globals KryosDungeonTool MenuUtil MenuResponse C_EquipmentSet UnitCastingInfo UIErrorsFrame ERR_CLIENT_LOCKED_OUT EQUIPMENT_SETS GameTooltip UNKNOWN GAMEMENU_OPTIONS FONT_SIZE UIParent NORMAL_FONT_COLOR RAID_CLASS_COLORS CUSTOM_CLASS_COLORS UnitClass
...
local function createAceWindow()
	...
	local useClassColor = GetAceGUI():Create("CheckBox")
	...
	local useTextColor = GetAceGUI():Create("CheckBox")
