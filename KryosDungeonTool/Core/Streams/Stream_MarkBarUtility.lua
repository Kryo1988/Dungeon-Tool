-- luacheck: globals KryosDungeonTool
...
local function buildParts(size)
	...
	parts[#parts + 1] = {
		text = textureIcon("Interface\\AddOns\\KryosDungeonTool\\Modules\\MythicPlus\\Art\\coreRC.tga", size),
		secure = {
			forwardRightClick = true,
			attributes = {
				type = "macro",
	...
	parts[#parts + 1] = {
		text = textureIcon("Interface\\AddOns\\KryosDungeonTool\\Modules\\MythicPlus\\Art\\corePull.tga", size),
		secure = {
			forwardRightClick = true,
			attributes = {
				type = "macro",
