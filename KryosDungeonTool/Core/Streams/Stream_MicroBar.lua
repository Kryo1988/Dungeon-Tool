-- luacheck: globals KryosDungeonTool MenuUtil MenuResponse C_AddOns UIParentLoadAddOn PlayerSpellsUtil C_Garrison C_Covenants Enum ShowGarrisonLandingPage HousingFramesUtil ToggleCharacter ToggleProfessionsBook ToggleAchievementFrame ToggleQuestLog ToggleCalendar ToggleTimeManager ToggleEncounterJournal ToggleGuildFrame PVEFrame_ToggleFrame ToggleCollectionsJournal ToggleGameMenu ToggleHelpFrame ToggleChannelFrame ToggleFriendsFrame UnitClass
...
KryosDungeonTool.DataHub.RegisterStream(provider)
