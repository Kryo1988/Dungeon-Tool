-- luacheck: globals KryosDungeonTool GetAverageItemLevel GetItemLevelColor GetInventoryItemLink GetInventoryItemTexture C_Item GetDetailedItemLevelInfo NOT_APPLICABLE ITEM_LEVEL_ABBR STAT_AVERAGE_ITEM_LEVEL STAT_AVERAGE_ITEM_LEVEL_EQUIPPED LFG_LIST_ITEM_LEVEL_INSTR_PVP_SHORT EQUIPPED
