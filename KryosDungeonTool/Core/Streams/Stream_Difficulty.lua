-- luacheck: globals KryosDungeonTool DifficultyUtil MenuResponse SetRaidDifficulties
...
local I_DUNGEON = "|TInterface\\Addons\\KryosDungeonTool\\Icons\\Dungeon:%d:%d:0:0|t"
local I_RAID = "|TInterface\\Addons\\KryosDungeonTool\\Icons\\Raid:14:14:0:0|t"
