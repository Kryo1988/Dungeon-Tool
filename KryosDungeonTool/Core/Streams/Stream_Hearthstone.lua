-- luacheck: globals KryosDungeonTool GetBindLocation GAMEMENU_OPTIONS FONT_SIZE UIParent NORMAL_FONT_COLOR C_Timer UNKNOWN C_Item GetItemInfoInstant GetItemIcon
