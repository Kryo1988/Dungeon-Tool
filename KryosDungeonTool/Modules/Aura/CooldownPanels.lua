...
local L = LibStub("AceLocale-3.0"):GetLocale("KryosDungeonTool_Aura")
...
_G["BINDING_NAME_KDT_TOGGLE_COOLDOWN_PANELS"] = L["CooldownPanelBindingToggle"] or "Toggle Cooldown Panel Editor"
...
local function applyPanelBorder(frame)
	...
	local borderPath = "Interface\\AddOns\\KryosDungeonTool\\Assets\\PanelBorder_"
	local cornerSize = 70
...
local function applyInsetBorder(frame, offset)
	...
	local path = "Interface\\AddOns\\KryosDungeonTool\\Assets\\border_round_"
	local cornerSize = 36
	local edgeSize = 36
...
local function ensureEditor()
	...
	frame.bg:SetTexture("Interface\\AddOns\\KryosDungeonTool\\Assets\\background_dark.tga")
	...
	left.bg:SetTexture("Interface\\AddOns\\KryosDungeonTool\\Assets\\background_gray.tga")
	...
	right.bg:SetTexture("Interface\\AddOns\\KryosDungeonTool\\Assets\\background_gray.tga")
	...
	middle.bg:SetTexture("Interface\\AddOns\\KryosDungeonTool\\Assets\\background_gray.tga")
